  ...
  List data = [
    {
      ...
      "sub":
          "Your order of ipsoem loreum has been recived will be delivered by Nov 24th thursday"
    },
    {
      "title": "Your order has been Cancelled",
      "sub":
          "Your cancell request order of ipsoem loreum has been approved refund will be credite in your account shortly"
    },
    {
              ...
              itemBuilder: (context, index) => SizedBox(
                ...
                child: ListTile(
                  ...
                  shape: const RoundedRectangleBorder(
                      side: BorderSide(color: AppColorPallet.grey_)),
                  tileColor: selectedIndex == index
                      ? AppColorPallet.listtilegrey
