...
class _ProductscrnState extends State<Productscrn> {
  var activeindex = 0;
  List image = ["assets/macrome.jpg", "assets/macrome.jpg", "assets/macrome.jpg"];
            ...
            SingleChildScrollView(
              child: Column(children: [
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: next,
                        child: SvgPicture.asset(AppLeadingIcons.forwardbtn),
                      ),
                    ],
                  ),
               ...
               child: Container(
                 ...
                 child: Column(
                   children: [
                     ...
                     Padding(
                       padding: const EdgeInsets.only(left: 31, right: 19,bottom:24),
                       child: Row(
                     ...
                     Padding(
                       padding: const EdgeInsets.only(left: 33, right: 19,bottom: 16),
                       child: Column(
